    ...
    <section id="contact" className="contact">
      <div className="container">
        <div className="contact-inner" data-aos="fade-up">
          ...
          <a href="mailto:gauraryan1027@gmail.com" className="contact-email-btn">
            <span>gauraryan1027@gmail.com</span>
          ...
          <div className="contact-socials">
            ...
            <a href="mailto:gauraryan1027@gmail.com" className="social-link">
